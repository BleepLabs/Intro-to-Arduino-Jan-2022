...
// 8x8 is the easisest but you can use any size. see https://github.com/BleepLabs/Arduino-Light-And-Sound/blob/master/Class_4/Class_4_-_bitmap_3_large_text/Class_4_-_bitmap_3_large_text.ino for info on scrolling it
