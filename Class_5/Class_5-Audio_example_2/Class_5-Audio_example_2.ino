...
// https://www.pjrc.com/teensy/gui/#include <Audio.h>
#include <Audio.h>
#include <Wire.h>
#include <SPI.h>
#include <SD.h>
...
AudioSynthWaveform       waveform1;      //xy=100,342
AudioFilterStateVariable filter1;        //xy=103,262
AudioSynthSimpleDrum     drum1;          //xy=146,132
AudioSynthSimpleDrum     drum2;          //xy=164,184
AudioEffectEnvelope      envelope1;      //xy=246,247
AudioMixer4              mixer1;         //xy=413,190
AudioEffectDelay         delay1;         //xy=417,312
AudioAmplifier           amp1;           //xy=607,209
AudioOutputAnalog        dac1;           //xy=756,237
...
AudioConnection          patchCord9(amp1, dac1);
...
void setup() {
  ...
  envelope1.attack(10); //time in milliseconds to rise to full amplitude
  envelope1.decay(100); //time in milliseconds to fall to sustain amplitude
...
void loop() {
  ...
  note_select = map(analogRead(A3), 0, 1023, 0, 87);
