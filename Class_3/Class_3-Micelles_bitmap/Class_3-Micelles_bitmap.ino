...
//        if ( y_count == 2) {
//          float hue1 = (rainbow1 + x_count) / 14.0;
//          set_pixel(xy_count, hue1, 0.9, 1);
//        }

//        if ( x_count == xy_sel / 8.0) {
//          float hue1 = (rainbow1 + x_count) / 14.0;
//          set_pixel(xy_count, hue1, 0.9, 1);
//        }

//        if (bitmap2[y_count][x_count] == 1 ){
//          float r1 = random(20) / 40.0;
//          set_pixel(xy_count, r1, 1, 1);
//        }
        if (bitmap2[y_count][x_count] == 1 ){
          float r1 = rainbow1 / 7.0;       
          set_pixel(xy_count, r1, 1, 1);
        }
        if (bitmap2[y_count][x_count] == 2 && x_count <= anim){
          float r1 = (x_count+rainbow1)/ 14.0;       
          set_pixel(xy_count, r1, 1, 1);
        }
        if (bitmap2[y_count][x_count] == 3 && x_count >= anim){
          float r1 = rainbow1 / 7.0;       
          set_pixel(xy_count, r1, 1, 1);
        }
        if (bitmap2[y_count][x_count] == 3 && x_count <= anim){
          float r1 = rainbow1 / 7.0;       
          set_pixel(xy_count, r1, 0, 1);
        }
